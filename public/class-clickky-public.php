...
class Clickky_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->clickky, plugin_dir_url( __FILE__ ) . 'css/сlickky-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->clickky, plugin_dir_url( __FILE__ ) . 'js/сlickky-public.js', array( 'jquery' ), $this->version, false );
