...
class Clickky {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-сlickky-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-сlickky-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-сlickky-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-сlickky-public.php';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Clickky_Admin( $this->get_clickky(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Clickky_Public( $this->get_clickky(), $this->get_version() );
