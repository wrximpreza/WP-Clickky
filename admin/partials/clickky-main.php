            ...
            <div id="test1" class="col s12">
                        ...
                        <div class="col s6">
                            <svg width="15" height="18" viewBox="0 0 15 18"
                                ...
                                <path
                                    ...
                                    data-reactid=".0.0.1.0.1.2.1.0.1.0.1.1.1.0"></path>
                            </svg>
                            <div class="inner percent">
                ...
                <div class="col s3 type">
                    ...
                    <div class="ibox">
                        ...
                        <div class="col s6">
                            <svg width="28" height="22" viewBox="0 0 28 22" data-reactid=".0.0.1.0.1.2.1.1.1.0.1.1.0"><path d="M28.011,20.265V1.756A1.72,1.72,0,0,0,26.324.01H1.686A1.72,1.72,0,0,0,0,1.756V20.265a1.72,1.72,0,0,0,1.687,1.746H26.324A1.719,1.719,0,0,0,28.011,20.265Zm-0.97-9.254a0.253,0.253,0,1,1-.253-0.262A0.258,0.258,0,0,1,27.041,11.011Zm-26.113,0a0.515,0.515,0,0,1,.506-0.524,0.524,0.524,0,0,1,0,1.048A0.515,0.515,0,0,1,.927,11.011Zm1.561,9.6V1.407H25.522V20.614H2.488Z" data-reactid=".0.0.1.0.1.2.1.1.1.0.1.1.0.0"></path></svg>
                            <div class="inner percent">
